        ...
        <View className="flex-1">
          ...
          >
            <View className="mx-5 mt-10">
              ...
              <View className="mt-5">
                <TouchableOpacity onPress={() => router.push('/(root)/(driver)/')} className="flex-row items-center gap-3 py-2">
                ...
                <TouchableOpacity onPress={() => router.push('/(root)/(driver)/review')} className="flex-row items-center gap-3 py-2">
